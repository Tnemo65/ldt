#!/usr/bin/env python3
"""Generate synthetic NYC taxi data for kafka-producer."""
import pandas as pd
import numpy as np
...
df.to_parquet("/data/nyc_taxi_300k.parquet", index=False)
print(f"Generated {N} rows -> /data/nyc_taxi_300k.parquet")
