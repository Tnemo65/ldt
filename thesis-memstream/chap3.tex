...
\caption{34D Feature Vector for Online Autoencoder.}
...
The ADWIN algorithm monitors each of the six meta-metrics per neighborhood independently. Drift is declared when the statistical divergence between the older sub-window $W_0$ and newer sub-window $W_1$ exceeds the Hoeffding-derived cutoff, at which point $W_0$ is dropped and $W_1$ becomes the new reference. ADWIN instances are reset independently per neighborhood.
