...
\begin{itemize}
    ...
    \item \textbf{Model Artifact Storage:} Trained Hybrid K-Means iForestASD model artifacts (serialized Pickle files) are archived in \texttt{models} bucket, enabling model versioning and rollback through MLflow Model Registry.
\end{itemize}
