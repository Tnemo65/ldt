...
The 4D context-aware thresholds work synergistically with the Hybrid K-Means iForestASD model (Section 4.5):
...
% ================================================
% 4.5 Innovation 4: Hybrid K-Means iForestASD Model [RQ2]
% ================================================
...
\begin{itemize}
    \item \textbf{ONE global iForestASD model} trained on all 2.97M records across all clusters
