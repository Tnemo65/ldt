...
\begin{itemize}
    ...
    \item \textbf{Validated performance:} F1=0.91, meeting production targets (FPR below threshold, Recall exceeding target)
\end{itemize}
...
\begin{enumerate}
    ...
    \item \textbf{Hybrid K-Means iForestASD [RQ2]:} Combines parametric clustering (K-Means) with non-parametric anomaly scoring (Isolation Forest) for context-aware multivariate detection, achieving F1=0.91.
\end{enumerate}
