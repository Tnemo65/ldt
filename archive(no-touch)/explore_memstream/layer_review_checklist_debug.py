...
print(fDEBUG: _MEMSTREAM_ROOT={_MEMSTREAM_ROOT} exists={_MEMSTREAM_ROOT.exists()} in_path={str(_MEMSTREAM_ROOT) in sys.path}\nif str(_MEMSTREAM_ROOT) not in sys.path:
...
def run_automated_checks(layer_id: str) -> List[Dict]:
    ...
    if layer_id == 'input':
        ...
        try:
            ...
            cfg_path = _MEMSTREAM_ROOT / 'core' / 'memstream_core.py'
